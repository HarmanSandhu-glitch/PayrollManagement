...
function submitEmployeeForm(event) {
    ...
    const employee = {
        ...
        employeeDepartment: { departmentId: document.getElementById('employeeDepartment').value },
        employeePosition: { positionId: document.getElementById('employeePosition').value }
    };
...
function editEmployee(id) {
    fetch(`/api/employees/${id}`, {
        ...
        .then(employee => {
            ...
            document.getElementById('employeeDepartment').value = employee.employeeDepartment.departmentId;
            document.getElementById('employeePosition').value = employee.employeePosition.positionId;
            showAddEmployeeForm();
        });
}
